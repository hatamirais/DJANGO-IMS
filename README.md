...
- Procurement contract: `DRAFT -> SUBMITTED -> APPROVED -> CLOSED`, dengan soft-cancel `DRAFT/SUBMITTED/APPROVED -> CANCELLED` sebelum realisasi penerimaan; amendment: `DRAFT -> SUBMITTED -> APPROVED`. Approval Kepala/Admin hanya menyinkronkan rencana penerimaan procurement, tidak memutasi stok; role `GUDANG` tidak menjalankan checkpoint approval.
