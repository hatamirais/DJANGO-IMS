...
- Untuk procurement berbasis SPJ, approval kontrak di modul `procurement` akan membuat atau memperbarui tepat satu planned receiving yang ditautkan ke kontrak tersebut. Form rencana penerimaan manual di modul `receiving` hanya membuat dokumen tanpa kontrak. Form SPJ juga menyediakan quick-create supplier dan sumber dana langsung dari halaman create/edit melalui endpoint procurement yang tervalidasi.
