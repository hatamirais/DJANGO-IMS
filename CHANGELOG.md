...
- Completed stock opname migration backfills now reconstruct completion-time `Stok Update` from ledger movements between opname creation and completion instead of freezing deployment-time live stock.
