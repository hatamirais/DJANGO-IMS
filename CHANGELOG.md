...
- Completed stock opname migration backfills now reconstruct completion-time `Stok Update` from ledger movements between each item snapshot and completion instead of freezing deployment-time live stock.
